    ...
    pages: [
      {
        ...
        preamble: [
          {
            heading: "1. You give us the brief.",
            body: "For each LOR and internship, fill in a few short fact-based fields. Be concise — your counsellor will draft the professional document from these notes.",
          },
          {
            heading: "2. Your counsellor drafts the document.",
            body: "You'll see a status update on your dashboard when each item is ready.",
          },
          {
            heading: "3. You'll receive the draft to print on official letterhead.",
            body: "Take the LOR to the recommender. Take the internship document to the company. Get it signed and stamped.",
          },
          {
            heading: "4. Upload the stamped final within 5 business days.",
            body: "Brightly lit photo or PDF, on a flat surface — this document goes directly to your universities.",
          },
          {
            heading: "5. Your Statement of Purpose is fully drafted by your counsellor and approved by admin.",
            body: "Nothing for you to upload — the SOP they prepare is the final document.",
          },
        ],
        fields: [
          {
