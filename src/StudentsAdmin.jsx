...
const DOC_SOURCES = {
  // ── ID ───────────────────────────────────────────────────────────────────
  aadharFile:            { section: "Personal Info → Identity Documents", note: "Ask the student to upload their Aadhaar card (front + back) in the Personal Info section of the intake form." },
  photoFile:             { section: "Personal Info → Identity Documents", note: "Ask the student to upload a recent passport-size photograph in the Personal Info section." },
  passportFrontBack:     { section: "Personal Info → Passport", note: "Ask the student to upload a single PDF containing all passport pages in the Personal Info section." },
  passportFront:         { section: "Personal Info → Passport", note: "Ask the student to upload the passport bio-data (front) page in the Personal Info section." },
  passportLast:          { section: "Personal Info → Passport", note: "Ask the student to upload the passport last/back page in the Personal Info section." },
  // ── Academic ─────────────────────────────────────────────────────────────
  marks10sheet:          { section: "Academic → Class 10 → Marksheet", note: "Ask the student to upload their Class 10 marksheet in the Academic section." },
  marks11sheet:          { section: "Academic → Class 11 → Marksheet", note: "Ask the student to upload their Class 11 marksheet in the Academic section." },
  marks12predictedSheet: { section: "Academic → Class 12 → Predicted Marksheet", note: "Ask the student to upload their Class 12 predicted or provisional marksheet in the Academic section. Applicable before final results." },
  marks12sheet:          { section: "Academic → Class 12 → Final Marksheet", note: "Ask the student to upload their final Class 12 marksheet once results are declared in the Academic section." },
  admitCardFile:         { section: "Academic → Entrance Exams → Admit Card", note: "Ask the student to upload their college/university entrance exam admit card in the Academic section." },
  transcript:            { section: "Academic → University / College → Official Transcript", note: "Ask the student to upload an official university transcript in the Academic section. Must be sealed/signed." },
  finalDegree:           { section: "Academic → University / College → Degree Certificate", note: "Ask the student to upload their degree certificate in the Academic section. Applicable for graduate applicants." },
  semesterTranscripts:   { section: "Academic → University / College → Semester Transcripts", note: "Ask the student to upload individual semester marksheets in the Academic section. Required for UG applicants." },
  // ── Tests ────────────────────────────────────────────────────────────────
  ielts_result:          { section: "Test Scores → IELTS", note: "Ask the student to upload their official IELTS Test Report Form in the Test Scores section." },
  toefl_result:          { section: "Test Scores → TOEFL", note: "Ask the student to upload their official TOEFL score report in the Test Scores section." },
  sat_result:            { section: "Test Scores → SAT / ACT", note: "Ask the student to upload their SAT or ACT score report in the Test Scores section." },
  // ── Resume ───────────────────────────────────────────────────────────────
  resumeFile:            { section: "Auto-generated by AI pipeline", note: "The resume is generated automatically from the student's intake data after they complete the form. The student may also upload one directly. If missing, verify AI processing has run." },
  // ── Financial ────────────────────────────────────────────────────────────
  itr:                   { section: "Financial Documents → Income Tax Returns", note: "Ask the student's parent/guardian to upload ITR (Income Tax Return) documents for the last 2–3 years in the Financial section." },
  income:                { section: "Financial Documents → Income Certificate", note: "Ask for a salary slip or Form 16 from the parent/guardian's employer in the Financial section." },
  business:              { section: "Financial Documents → Business Proof", note: "Ask for business registration documents, balance sheet, or P&L statement if the parent runs a business in the Financial section." },
  kyc:                   { section: "Financial Documents → KYC", note: "Ask the student/guarantor to upload PAN card and Aadhaar of the financial guarantors in the Financial section." },
  loan:                  { section: "Financial Documents → Education Loan", note: "Ask for the bank's loan sanction letter if a student loan is being taken in the Financial section. Not required if no loan." },
  networth:              { section: "Financial Documents → Net Worth Certificate", note: "Ask for a CA-certified Net Worth Certificate of the parent/guardian in the Financial section." },
  affidavit:             { section: "Financial Documents → Affidavit", note: "Ask for the duly stamped and signed financial affidavit in the Financial section." },
  banking:               { section: "Financial Documents → Bank Statements", note: "Ask the parent/guardian to upload 6-month bank statements in the Financial section." },
  travel:                { section: "Financial Documents → Travel History", note: "Ask the student to upload copies of previous visas or travel documents in the Financial section." },
  // ── Required Docs (by kind) ──────────────────────────────────────────────
  lor:                   { section: "Required Docs → Letter of Recommendation", note: "Student fills in the recommender's name, subject, and a brief reason during intake. Counsellor drafts the LOR. Student then collects the signed and stamped copy from the recommender and uploads it here." },
  internship:            { section: "Work & Activities → Internship → Experience Certificate", note: "Student fills in the company name and their role during intake. Counsellor drafts the experience certificate. Student then gets it signed and stamped by the company and uploads it here." },
  ngo:                   { section: "Work & Activities → NGO / Volunteering → Certificate", note: "Student fills in the NGO name and volunteering activities during intake. Counsellor drafts the certificate. Student then gets it signed by the organisation and uploads it here." },
  extracurricular:       { section: "Work & Activities → Extracurricular → Participation Letter", note: "Student fills in the activity and institution during intake. Counsellor drafts the participation letter. Student gets it signed by the institution or coach and uploads it here." },
  sop:                   { section: "Statement of Purpose", note: "The SOP is drafted entirely by the counsellor using the student's academic record, activities, internships, and personal summary from their intake. Admin must approve before it is shown to the student. No student upload is required." },
};
